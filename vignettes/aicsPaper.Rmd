...
Those steps shows how to prepare the sample information si it can be used 
as input for ancestry inference.

First, you need a mapped BAM file
for each sample. The reference genome used for the mapping must correspond 
to the one used to generate the 1KG GDS file. In this case, genome hg38.
