...
and a profile-specific subset of SNVs is retained for each sample. This 
...
fileName1KG <- "ex1kg.gds"
fileGDS <- file.path(path1KG, fileName1KG)
...
for(i in seq_len(length(listSamples))) {
    ...
    ## This is required.
    addStudy1Kg(gds1KG, fileGDSProfile)
}
