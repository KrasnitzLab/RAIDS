...
## The profiles must be present in the Profile PED RDS file
## and must have an associated Profile SNP pileup file.
...
##############################################################
## All Profile GDS files need to be located in the same 
## directory.
##############################################################
PATHSAMPLEGDS <- file.path(data.dir, "example", "out")
...
for(i in seq_len(length(listSamples))) {
    ...
    pruningSample(gds=gds_1KG, currentProfile = listSamples[i],
