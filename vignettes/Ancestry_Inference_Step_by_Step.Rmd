...
The nodes, with the genotype information for the pruned SNVs, are created in  
the **Profile GDS file**: 'sample.id', 'snp.id', 'snp.chromosome', 
'snp.position', 'snp.index', 'genotype' and 'lap'.
