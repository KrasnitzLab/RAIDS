...
There is one genotyping file per chromosome. The process must be executed 
for each of those files.

The 1KG VCF file is also required.
...
The function __generatePhase1KG2GDS()__ is adding the phse information 
