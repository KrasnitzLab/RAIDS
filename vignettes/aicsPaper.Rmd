...
<style>
div.whitesmoke pre.r { background-color:#fafafb; }
</style>
...
Using those 4 input files, the function _appendStudy2GDS1KG()_ will generate 
a GDS Sample file. 

One GDS Sample file is created for each sample passed as argument.
