...
pileup file called "Sample.01.txt.gz" would be associated to the 
sample "Sample.01". 
...
The row names of the *data.frame* must be the **Name.ID**.

This file is referred as the PED RDS file (PED for pedigree). Alternatively, 
the PED information can be saved in another type of file (CVS, etc..) as long 
as the data.frame information can be regenerated in R (with _read.csv()_ or 
else). 
...
##############################################################
## The rownames must correspond to the name of the samples
##############################################################
...
passed to the *listSamples* argument.
...
## the synthetic data
## The information is saved into the GDS sample file
##############################################################
...
####################################################################
## The path to the directory containing the GDS Sample files
####################################################################
...
for(i in seq_len(length(listSamples))) {
    ...
    ## The GDS Sample associated to the cancer sample     
...
## The samples must have an associated GDS Sample files.
