...
1. Format the information from 1000 Genomes (optional)
...
## Formatting the information from 1000 Genomes (optional)

Those steps explain how to generate the 1000 Genomes (1KG) GDS file that is 
needed to run the ancestry inference tool. Beware that it is unnecessary to 
re-run those steps as the 1KG GDS file is publicly available. 

<span style="color:red">The 1KG GDS file will be available soon.</span>

More specifically, the steps of this procedure are:
...
Beware that those steps are time, as well as, space consuming.

In the following sections, those steps are described in details.
