...
The format of those files are described the [Population reference dataset GDS files (optional)](Create_Reference_GDS_file.html) 
vignette.
...
## Step 2 - Wrapper function to run ancestry inference on DNA data in one command
