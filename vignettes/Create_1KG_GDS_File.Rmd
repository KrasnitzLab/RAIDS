---
title: "Formatting the information from the population reference dataset (optional)"
...
vignette: >
    %\VignetteIndexEntry{Formatting the information from the population reference dataset (optional)}
