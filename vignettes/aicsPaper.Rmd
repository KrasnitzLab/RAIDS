...
### Split the 1K genotyping file per sample
...
## Only the samples with genotyping information (file present in PATHGENO)
## are retained to create the final data.frame
