...
* **genotype**: a SNV genotypic *integer* *matrix* (i.e., the number of A alleles) in SNVs-major mode (number of Samples × number of SNvs) TODO validate mode type
...
The *Population Reference Annotation GDS file* should contain TODO
...
* **block.annot**: a *data.frame* containing those columns:
    * **block.id**: a *character* string representing TODO
    * **block.desc**: ! *character* string describing the block TODO
* **bloc**: TODO
