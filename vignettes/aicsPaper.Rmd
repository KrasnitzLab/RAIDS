...
related in the 1KG files. It generates a file with the unrelated patient 
information (filePart parameter) as well as a file with the kinship coefficient
between the patients (fileIBD parameter).
...
### Add information about unrelated 1KG patients to the 1KG GDS file
...
```{r pruningSample, echo=TRUE, eval=FALSE}
    ...
    gdsfile <- file.path(pathGDS, gdsName)
    ...
    sampleCurrent <- sample.id[study.start[pos] + sampleNum - 1]
