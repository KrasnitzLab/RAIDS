...
In addtions, a *data.frame* containing the general information about the 
...
**population reference GDS file** (called _ex1kg.gds_) and a small 
**population reference SNV Annotation GDS file** (called _exAnnot1kg.gds_) are 
...
used for a real ancestry inference. Beware that an ancestry inference done 
