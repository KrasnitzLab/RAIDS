...
2. Generate a Sample VCF file (1 file per sample)
3. Pruned SNPs using linkage desequilibrium analysis
...
In the situation where you would need to generate your own reference files, 
...
At this step, [snp-pileup](https://github.com/mskcc/facets/tree/master/inst/extcode) is used to 
generate a Sample VCF file that will contain the reference and alternative 
...
#### Step 3. Create a GDS Sample file (1 GDS file per sample)
...
###############################################
## The 2 GDS files related to the 1KG reference
...
## This function creates a GDS Sample file for each 
