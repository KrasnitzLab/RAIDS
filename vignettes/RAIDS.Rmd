...
example below, this directory is referred to as **path1KG**.
...
reference **1KG GDS file** must be created for each profile. This file is 
refereed as a **SNP pileup file**.
...
knitr::include_graphics("MainSteps_Step2_SubStep2_SNP-Pileup_v02.png")
```


The read counts can be extracted using different software such as Bioconductor 
[RSamtools](https://bioconductor.org/packages/release/bioc/html/Rsamtools.html) 
package [@Morgan2023] and  [snp-pileup](https://github.com/mskcc/facets/tree/master/inst/extcode), 
which is associated to the facets package [@Shen2016]


The generic **SNP pileup file** format is coma separated and the 
...
Beware that the starting position in the **1KG GDS file** is zero (like BED 
files). The **SNP pileup file** should also start at position zero.
...
# Pre-processed reference files are available
