...
containt the information related to 1KG:

```{r gdsCreation, echo=FALSE, eval=FALSE}
## The path and file names of the required files
## First, the RDS file containing the pedigree information
## Second, the bulk SNP information file
## Third, the RDS file with the indexes of the retained SNPs
## Fourth, the RDS file with the filtered SNP information 
