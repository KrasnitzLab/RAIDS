...
### Download the required files from 1K
...
The genotyping file for the 1KG samples also needs to be downloaded:

TODO

### Split the 1K genotyping file to one file per sample
...
### Prepare intermediate SNP info file based on 1KG VCF for GDS
...
from Bioconductor [gdsfmt](https://bioconductor.org/packages/gdsfmt/).

The intermediate SNP file contains the SNP position as well as the frequency 
...
The intermediary SNP info file is called '__matFreqSNV.txt__'.

<br>
<br>

### Filter intermediate SNP info file

The intermediate SNP file is filtered to only retain the SNPs with frequency 
...
## Filter the intermediate SNP file (fileSNV parameter)
